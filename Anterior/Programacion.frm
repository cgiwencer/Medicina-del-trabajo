...
Begin VB.Form Programacion 
   ...
   Begin SSDesignerWidgetsTabs.SSIndexTab SSIndexTab1 
      ...
      Tabs(2).Pages(0).CtlEnabled=   -1  'True
      ...
      Begin MSAdodcLib.Adodc Adodc3 
         ...
         UserName        =   "root"
         Password        =   "cagisa"
         RecordSource    =   "Select * from nuevos Where NueEst = 1 AND NueTip=""REINGRESO"""
         Caption         =   "Adodc1"
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "MS Sans Serif"
            Size            =   8.25
...
If SSIndexTab1.Tab = 0 Then
    ...
    Else
        Adodc1.RecordSource = "Select * from nuevos Where NueEst = 1 AND NueTip= 'PREOCUPACIONAL'  ORDER BY NueFem DESC"
        Adodc1.Refresh
    End If
...
ElseIf SSIndexTab1.Tab = 1 Then
    ...
    Else
        Adodc2.RecordSource = "Select * from nuevos Where NueEst = 1 AND NueTip= 'POSTOCUPACIONAL'  ORDER BY NueFem DESC"
        Adodc2.Refresh
    End If
ElseIf SSIndexTab1.Tab = 2 Then
    ...
    Else
        Adodc3.RecordSource = "Select * from nuevos Where NueEst = 1 AND NueTip= 'REINGRESO'  ORDER BY NueFem DESC"
        Adodc3.Refresh
    End If
ElseIf SSIndexTab1.Tab = 3 Then
    If Len(Trim(Text8.Text)) > 0 Then
        ...
        db1 = Text8.Text
        Adodc4.RecordSource = "SELECT * from nuevos WHERE  NueNom LIKE " & "'%" & db1 & "%' AND NueEst = 3 ORDER BY NueFem DESC"
        Adodc4.Refresh
        Text8.Text = ""
...
ElseIf SSIndexTab1.Tab = 4 Then
    If Len(Trim(Text8.Text)) > 0 Then
        ...
        db1 = Text8.Text
        Adodc5.RecordSource = "SELECT * from nuevos WHERE  NueNom LIKE " & "'%" & db1 & "%' AND NueEst = 4 ORDER BY NueFem DESC"
        Adodc5.Refresh
        Text8.Text = ""
...
limpiadatos
If SSIndexTab1.Tab = 0 Then
    Adodc1.RecordSource = "Select * from nuevos Where NueEst = 1 AND NueTip = 'PREOCUPACIONAL'"
    Adodc1.Refresh
End If
If SSIndexTab1.Tab = 1 Then
    Adodc2.RecordSource = "Select * from nuevos Where NueEst = 1 AND NueTip = 'POSTOCUPACIONAL'"
    Adodc2.Refresh
ElseIf SSIndexTab1.Tab = 2 Then
    Adodc3.RecordSource = "Select * from nuevos Where NueEst = 1 AND NueTip = 'REINGRESO'"
    Adodc3.Refresh
ElseIf SSIndexTab1.Tab = 3 Then
    SSFrame1.Visible = True
